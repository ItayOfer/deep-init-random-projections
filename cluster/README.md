...
| 10 | [`10_rc_frozen_ends/`](10_rc_frozen_ends/README.md) | Jul 17–18 | 100L `row_centered_he`, train only last3 (fc99,fc100,head) vs only first3 (fc1,fc2,fc3) — everything else frozen | Both DEAD/STUCK at 20 ep — neither entry point trains; `last3` gradient underflows to exact float32 zero, `first3` gradients stay healthy but produce zero loss movement (absorbed by 97 frozen layers); audits not gated |
