...
- **Initialization comparison**: Uniform vs He vs Row-Centered
...
|----------|-------------|
| Uniform | U(-a, a) where variance = 2/d |
| He (Gaussian) | N(0, sqrt(2/d)) |
| Row-Centered | N(0, sqrt(2/d)) with row means subtracted |
...
- Comparison across initialization strategies (he, row_centered_he, xavier, uniform_he)
